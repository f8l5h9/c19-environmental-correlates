...
In addition to the two key environmental variables that are the focus of this research, we consider as controls the economic and demographic variables variables shown in  Table \ref{tab:descriptive-statistics}. The descriptive statistics as well as the sources of the data can be found there. 
